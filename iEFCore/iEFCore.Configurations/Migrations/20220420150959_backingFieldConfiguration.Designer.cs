...
namespace iEFCore.Configurations.Migrations
{
    ...
    [Migration("20220420150959_backingFieldConfiguration")]
    partial class backingFieldConfiguration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iEFCore.Configurations.Entities.BackingFieldSample", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("_birthDateField")
                        .HasColumnType("datetime2")
                        .HasColumnName("DateOfBirth");

                    b.HasKey("Id");

                    b.ToTable("BackingFieldSamples", "dbo");
                });
            ...
            modelBuilder.Entity("iEFCore.Configurations.Entities.IndexUsingAttribute", b =>
                {
                    ...
                    b.ToTable("IndexUsingAttributes", "dbo");
                });
            ...
            modelBuilder.Entity("iEFCore.Configurations.Entities.IndexUsingFluentAPI", b =>
                {
                    ...
                    b.ToTable("IndexUsingFluentAPIs", "dbo");
                });

            modelBuilder.Entity("iEFCore.Configurations.Entities.News", b =>
                {
            ...
            modelBuilder.Entity("iEFCore.Configurations.Entities.PrimaryKeyAttribute", b =>
                {
                    ...
                    b.ToTable("PrimaryKeyAttributes", "dbo");
                });
            ...
            modelBuilder.Entity("iEFCore.Configurations.Entities.PrimaryKeyFluent", b =>
                {
                    ...
                    b.ToTable("PrimaryKeyFluents", "dbo");
                });
            ...
            modelBuilder.Entity("iEFCore.Configurations.Entities.ReadOnlyAttribute", b =>
                {
                    ...
                    b.ToTable("ReadOnlyAttributes", "dbo");
                });
